Here is live coding session for a candidate

What should be done in terms of live coding session:

1. Implement a list of cars, using the url provided in RequestProvider.swift.
    Car item should containt:
    * Title
    * Description
    * Thumbnail
    Design and item placement is up to candidate
2. By tapping on a cell in a list of cars, user should be navigated to car details
3. On details screen all information which is received from the *href* link of a cell should be displayed on a screen.
Design and item placement is up to candidate
